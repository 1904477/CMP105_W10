...
Map::Map()
{
	mapConf.loadTexture("gfx/marioTiles.png");
	GameObject tile;
	...
	std::vector<int> map = {
		...
		1, 2, 3, 4, 6, 1, 2, 3, 0, 0,
		4, 5, 6, 0, 0, 4, 5, 6, 0, 0 };
	mapConf.setTileMap(map, mapSize);
	mapConf.setPosition(sf::Vector2f(0, 408));
	mapConf.buildLevel();
